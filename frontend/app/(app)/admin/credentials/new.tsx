...
import { useCreateAdminCredential } from "../../../../src/hooks/useAdmin";
import { ApiError } from "../../../../src/api/client";
import { useColors } from "../../../../src/theme/colors";
import { credentialSchema, type CredentialInput } from "../../../../src/utils/validation";

export default function NewAdminCredentialScreen() {
    ...
    return (
      <Screen center>
        <EmptyState
          ...
          subtitle="Open a user's credentials list to add one for them."
        />
      </Screen>
    );
  }
  ...
  return (
    <Screen scroll>
      ...
      <Text className="mb-4 text-sm text-subtle">For {username || "this user"}</Text>
